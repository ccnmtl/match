...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CounselingSession.available_time'
        db.add_column('nutrition_counselingsession', 'available_time', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CounselingSession.available_time'
        db.delete_column('nutrition_counselingsession', 'available_time')
