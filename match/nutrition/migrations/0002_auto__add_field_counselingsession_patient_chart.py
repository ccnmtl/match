...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CounselingSession.patient_chart'
        db.add_column('nutrition_counselingsession', 'patient_chart', self.gf('django.db.models.fields.TextField')(default=datetime.date(2012, 7, 21)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CounselingSession.patient_chart'
        db.delete_column('nutrition_counselingsession', 'patient_chart')
