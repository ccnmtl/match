...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CounselingSession.patient_chart'
        db.alter_column('nutrition_counselingsession', 'patient_chart', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'CounselingSession.patient_chart'
        db.alter_column('nutrition_counselingsession', 'patient_chart', self.gf('django.db.models.fields.TextField')(default=datetime.date(2012, 9, 6)))
