...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CounselingReferralState'
        db.create_table('nutrition_counselingreferralstate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='nutrition_referral_user', to=orm['auth.User'])),
            ('referral_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('referred_to', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('referred_from', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('reason', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('medical_history', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('nutrition', ['CounselingReferralState'])

        # Adding model 'CounselingReferral'
        db.create_table('nutrition_counselingreferral', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('patient_chart', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('nutrition', ['CounselingReferral'])


    def backwards(self, orm):
        
        # Deleting model 'CounselingReferralState'
        db.delete_table('nutrition_counselingreferralstate')

        # Deleting model 'CounselingReferral'
        db.delete_table('nutrition_counselingreferral')
    ...
    models = {
        ...
        'nutrition.counselingreferral': {
            'Meta': {'object_name': 'CounselingReferral'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'patient_chart': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        'nutrition.counselingreferralstate': {
            'Meta': {'object_name': 'CounselingReferralState'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'medical_history': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'reason': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'referral_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'referred_from': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'referred_to': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'nutrition_referral_user'", 'to': "orm['auth.User']"})
        },
