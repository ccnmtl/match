...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageMapItem.label_name'
        db.add_column('main_imagemapitem', 'label_name', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageMapItem.label_name'
        db.delete_column('main_imagemapitem', 'label_name')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 13, 13, 26, 6, 473209)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 13, 13, 26, 6, 473064)'}),
