...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageMapItem.map_area_shape'
        db.add_column('main_imagemapitem', 'map_area_shape', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageMapItem.map_area_shape'
        db.delete_column('main_imagemapitem', 'map_area_shape')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 13, 11, 27, 50, 928573)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 13, 11, 27, 50, 928429)'}),
