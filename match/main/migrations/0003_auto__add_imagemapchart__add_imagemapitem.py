...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_imagemapchart', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('main', ['ImageMapChart'])

        # Adding M2M table for field items on 'ImageMapChart'
        db.create_table('main_imagemapchart_items', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('imagemapchart', models.ForeignKey(orm['main.imagemapchart'], null=False)),
            ('imagemapitem', models.ForeignKey(orm['main.imagemapitem'], null=False))
        ))
        db.create_unique('main_imagemapchart_items', ['imagemapchart_id', 'imagemapitem_id'])

        # Adding model 'ImageMapItem'
        db.create_table('main_imagemapitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('main', ['ImageMapItem'])


    def backwards(self, orm):
        
        # Deleting model 'ImageMapChart'
        db.delete_table('main_imagemapchart')

        # Removing M2M table for field items on 'ImageMapChart'
        db.delete_table('main_imagemapchart_items')

        # Deleting model 'ImageMapItem'
        db.delete_table('main_imagemapitem')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 6, 12, 27, 1, 896625)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 6, 12, 27, 1, 896462)'}),
        ...
        'main.imagemapchart': {
            'Meta': {'object_name': 'ImageMapChart'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.ImageMapItem']", 'symmetrical': 'False'})
        },
        'main.imagemapitem': {
            'Meta': {'object_name': 'ImageMapItem'},
